...
- How you will frame the misinformation to be subtle, authoritative, and non-obviously contradictory.

Then, generate the final output in the required JSON format. The JSON must include:
- "distractor_doc": A formal, encyclopedic-style document with plausible misinformation aligned with the guidelines.
