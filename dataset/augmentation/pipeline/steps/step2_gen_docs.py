...
Render actual document content from unified types (source_type + description_type) generated in Step1.
These documents establish world knowledge and support OQ and NQ answers.
"""
...
"""
    ...
    # Core constraints to avoid confusion
...
def extract_content(text: str) -> str:
    """Extract <content> tag content from LLM response"""
...
def process_sample(
    ...
    """Process single sample, generate document content based on unified types"""
    ...
    # Get facts info (for building fact content)
...
# ---------------------
class Step2GenDocs:
    """Step 2: Generate document content based on unified types (establish world knowledge)"""
    ...
    def run(
        ...
        stats = {
            ...
            "total_docs_generated": 0,  # Track total docs generated
        }
            ...
            with tqdm(total=total, desc="Rendering docs", unit="sample") as pbar:
                for fut in as_completed(future_map):
                    ...
                    try:
                        ...
                        stats["total_docs_generated"] += len(docs_list)  # Count docs
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Step 3: Render documents with origin/nq distinction + valid flag + valid_docs field.")
